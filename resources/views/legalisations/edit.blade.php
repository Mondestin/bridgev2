...
<div class="content-header">
   <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-12">
          <h1 align="center" class="m-0 text-dark">Actualisé la Légalisation</h1>
...
@section('content')
 ...
 <form action="{{route('legalisations.update', $data->id)}}"  method="POST" enctype="multipart/form-data">
    @csrf
       @method('PATCH')
      <div class="row padd">
       <!-- Left side elements -->
        <div class="col-md-6">
           <h3 class="box-title"> 
            ...
            </i>&nbsp;Information sur le demandeur
           </h3>         
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ $data->surname ?? '' }}">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $data->email ?? '' }}">           
          </div>
        </div>
        </div>          
     ...
     <div class="col-md-6">
       ...
       <div class="line_box">
          ...
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control numbers @error('school_name') is-invalid @enderror" name="school_name" value="{{ $data->school_name }}">
          </div>
           <div class="form-group col-md-6">
            ...
            <select name="type_legalisation" class="form-control @error('type_legalisation') is-invalid @enderror">
             <option  value="{{$data->type_legalisation}}" hidden selested>{{$data->type_legalisation}}</option>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control numbers @error('place_emission') is-invalid @enderror" name="place_emission" value="{{ $data->place_emission }}">
          </div>
          <div class="form-group col-md-6">
            <label for="type">Type de document</label>
            <span class="red">*</span>
            <input type="text" class="form-control numbers @error('type') is-invalid @enderror" name="type" value="{{ $data->type }}">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="date" class="form-control numbers @error('date_delivrance') is-invalid @enderror" name="date_delivrance" value="{{ $data->date_delivrance }}">
          </div>
           <div class="form-group col-md-6">
            <label for="document">Télécharger le document (JPG, JPEG, PNG)</label>
            <span class="red"></span>
            <input type="file" class="form-control numbers @error('document') is-invalid @enderror" name="document" value="{{ $data->document }}">
          </div>
        </div>
     </div>

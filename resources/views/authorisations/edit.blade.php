...
<div class="row" style="margin-top: 2%; margin-left: 1%; border-radius: 10px;">
 ...
 <form action="{{route('authorisations.update', $data->id)}}"  method="POST">
    @csrf
    @method('PATCH')
      <div class="row padd">
        <input type="text" name="id_number" value="{{$datas->id_number}}" style="display: none;">
       <!-- Left side elements -->
        <div class="col-md-6">
           <h3 class="box-title"> 
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('adresse') is-invalid @enderror" name="adresse" value="{{ $datas->addressSecondCountry}}" readonly="readonly">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('c_number') is-invalid @enderror" name="c_number" value="{{ $datas->id_number}}" readonly="readonly">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input name="relation_parent" class="form-control @error('relation_parent') is-invalid @enderror" value="{{ $data->relation_parent ?? '' }}">    
          </div>
        </div>
        </div> 
      ...
      <div class="line_box">
         ...
         <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('child_surname') is-invalid @enderror" name="child_surname" value="{{ $data->child_surname ?? '' }}">
          </div>  
          <div class="form-group col-md-6">
            <label for="Name">Prénom(s)</label>
            <span class="red">*</span>
            <input type="text" class="form-control @error('child_name') is-invalid @enderror" name="child_name" value="{{ $data->child_name ?? '' }}">
          </div>
        </div>
     </div>        
     ...
     <div class="row">
        ...
        <div class="row">
           ...
           <div class="form-group col-md-6">
            <label for="type">Relation avec l'enfant</label>
            <span class="red">*</span>
            <input type="text" class="form-control @error('relation_parent_2') is-invalid @enderror" name="relation_parent_2" value="{{ $data->relation_parent_2 ?? '' }}" >
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('b_contact') is-invalid @enderror" name="b_contact" value="{{ $data->b_contact ?? '' }}">
          </div>
          <div class="form-group col-md-6">
            <label for="adresse">Adresse</label>
            <span class="red">*</span>
      ...
      <div class="line_box">
        ...
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <span class="red">*</span>
            <textarea class="form-control @error('pouvoir') is-invalid @enderror text-dark" name="pouvoir">{{ $data->pouvoir }}</textarea> 

...
<div class="content-header">
   <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-12">
          <h1 align="center" class="m-0 text-dark">Laissez-Passer</h1>
      ...
      <div class="container-fluid" style="background: #eee;">
        <div class="row col-md-12 p-4">
            <div class="col-md-6 mb-3">
              <form action="{{route('findPassRange')}}" method="POST">
                @csrf
                @method('POST')
           ...
           <div class="col-md-6 right">
            <a href="#" id="print" class="btn btn-primary btnc">
              ...
              <a href="{{route('getExcelPass')}}" class="btn btn-success" title="Exporter la liste en Excel">
                <i class="fa-solid fa-file-excel"></i>
                Exporter la liste en Excel
              </a>
              <a href="{{route('pass.create')}}" class="btn btn-success">
              ...
              <table id="example1" class="table table-bordered table-striped table-sm dataTable" aria-describedby="example1_info" role="grid">
                ...
                <tr>
                 ...
                 <td>{{$value->name}} {{$value->surname}}</td>
                  ...
                  <td>
                    <form action="{{route('pass.destroy',$value->id)}}" method="post">
                        <?php if ($value->status=="Validé"): ?>
                            <a href="{{route('passPrint',$value->id)}}" class="btn btn-primary btn-sm btnprn" title="Imprimer le document">
                          <i class="fa fa-print" style="color: #fff;"></i>
                        </a>
                        <?php endif ?>
                        <a href="{{route('pass.edit',$value->id)}}" class="btn btn-warning btn-sm" title="Modifier">
               ...
               <div class="container-fluid text-center">
                 ...
                 <div class="row mb-2">
                   <div class="col-sm-12">
                    <br><br>
                    @if (empty($date1))
                    <h3 align="center" class="m-0 text-dark">LISTES DES LAISSEZ PASSER</h3>
                    @else
                    <h3 align="center" class="m-0 text-dark">LISTES DES LAISSEZ PASSER DU {{date("d-m-Y", strtotime($date1))}} AU {{date("d-m-Y", strtotime($date2))}}</h3>
                    @endif

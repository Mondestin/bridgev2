...
<div class="content-header">
   <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-12">
          <h1 align="center" class="m-0 text-dark">Fiche d'établissement d'une Procuration</h1>
...
@section('content')
     ...
     <div class="col-md-12">
      ...
      <div class="col-md-4">
              <div class="form-group">
                ...
                <form id="selectForm" action="{{route('findCitoyen2')}}"> 
                     @csrf
                     @method('POST')
 ...
 <form action="{{route('procurations.store')}}"  method="POST">
    @csrf
    @method('POST')
      <div class="row padd">
       ...
       <div class="line_box">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="number" class="form-control @error('b_contact') is-invalid @enderror" name="b_contact" value="{{ old('b_contact') }}">
          </div>
      ...
      <div class="line_box">
        ...
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <span class="red">*</span>
            <textarea class="form-control @error('pouvoir') is-invalid @enderror" name="pouvoir" rows="11" cols="50">{{ old('pouvoir') }}</textarea> 
          </div>
        </div>
     </div>

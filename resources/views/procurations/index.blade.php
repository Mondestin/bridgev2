...
<div class="content-header">
   <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-12">
          <h1 align="center" class="m-0 text-dark">Procurations</h1>
      ...
      <div class="container-fluid" style="background: #eee;">
        <div class="row col-md-12 p-4">
          <div class="col-md-7 mb-3">
            <form action="{{route('findProcuRange')}}" method="POST">
              @csrf
              @method('POST')
         ...
         <div class="col-md-5 float-right">
                    ...
                    <a href="{{route('getExcelProc')}}" class="btn btn-success" title="Exporter la liste en Excel">
                      <i class="fa-solid fa-file-excel"></i>
                      Exporter la liste en Excel
                    </a>
                    <a href="{{route('procurations.create')}}" class="btn btn-success">
                ...
                ?>
                 ...
                 <td>{{$value->citoyen_id}}</td>
                  ...
                  <td>
                    ...
                    <form action="{{route('procurations.destroy',$value->id)}}" method="post">
                        <a href="{{route('procurations.edit',$value->id)}}" class="btn btn-warning btn-sm mr-1" title="Modifier">
                        <i class="fa fa-pencil" style="color: #fff;"></i>
                        </a>
                        @if ($value->status == "Validé")
                        <!---->
                            <a href="{{route('printProcurations',$value->id)}}" class="btn btn-primary btn-sm btnprn mr-1" title="Imprimer">
